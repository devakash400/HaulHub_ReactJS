...
const PhoneInput: React.FC<PhoneInputProps> = ({
  ...
  return (
    <div
      ref={ref}
      className="relative flex items-center h-[48px] lg:h-[52px] rounded-xl border border-[#D0D5DD] bg-white px-3 lg:px-4 gap-1.5 lg:gap-2 focus-within:border-[#4A9B3D] focus-within:ring-2 focus-within:ring-[#4A9B3D]/20 transition-all"
    >
