...
const HowItWorks: React.FC = () => {
  return (
    <main
    className="min-h-screen w-full overflow-x-hidden bg-[#F6F1E8]"
  ...
  below to find, book, and return a trailer with confidence.
        ...
        <section className="border-t border-neutral-200 py-10 sm:py-14">
          ...
          <div className="flex flex-wrap gap-6 sm:gap-10">
            <div className="flex items-center gap-3">
              <span className="flex h-11 w-11 items-center justify-center rounded-full bg-[#389131]/15 text-[#389131]">
        ...
        {/* CTA */}
        <section className="border-t border-neutral-200 py-10 sm:py-14">
          <div className="rounded-2xl bg-neutral-900 px-6 py-10 text-center 
          sm:px-10 sm:py-12">
            ...
            <p className="mx-auto mt-3 max-w-md text-base text-neutral-300">
              Browse available trailers or list your own to earn when it’s not
              in use.
            </p>
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link
                to="/"
                className="inline-flex items-center gap-2 rounded-full bg-[#389131] px-6 py-3 text-white font-semibold hover:bg-[#2d7327]"
              >
                Browse trailers
              ...
              <Link
                to="/list-trailer"
                className="inline-flex items-center gap-2 rounded-full border-2 border-white/60 px-6 py-3 text-white font-semibold hover:bg-white/10"
              >
                List your trailer
              </Link>
            </div>
